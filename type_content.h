...
1)Login/Signup Page*/
void type_disp( const char* ,int );//function to display text to be typed.Parameters:(string,size of string)
void type_input(const char* ,int );//function that takes input from user to play the game and tracks right and wrong inputs.Parameters:(string,size of string)
